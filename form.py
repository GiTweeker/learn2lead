...
class DonateItemForm(FlaskForm):
   ...
   itemcat = SelectField(u'Item  Category', default="sponser",
                         choices=[('sponser', 'Sponsor'), ('infrastructure', 'Infrastructure'), ('studytools', 'Study Tools'),('writingtools', 'Writing Tools')])